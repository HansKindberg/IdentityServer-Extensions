			...
			get
			{
				...
				if(this._navigation == null)
				{
					...
					if(this.Facade.FeatureManager.IsEnabled(Feature.Diagnostics))
						this.AddNavigationNode(new[] {nameof(DiagnosticsController.Index), nameof(DiagnosticsController.AuthenticationScheme), nameof(DiagnosticsController.Configuration), nameof(DiagnosticsController.DataProtection), nameof(DiagnosticsController.Options), nameof(DiagnosticsController.RequestHeaders), nameof(DiagnosticsController.ResponseHeaders)}, nameof(Feature.Diagnostics), navigation);
